    ...
    if (bAxisIsManual) {
      ...
      if (useMultiAxisFeatures) {
        writeBlock(gWCSModal.format(68.1),
          ...
          gotYAxis ? "Y" + spatialFormat.format(0) : "",
...
function onCyclePoint(x, y, z) {
  ...
  case "thread-turning":
    if (getProperty("useSimpleThread") ||
      ...
      writeBlock(
        ...
        yOutput.format(y),
        zOutput.format(z),
        zFormat.isSignificant(r) ? g92ROutput.format(r) : "",
      ...
      if (isLastCyclePoint()) {
        ...
        writeBlock(
          ...
          xOutput.format(x),
          zOutput.format(z),
          zFormat.isSignificant(r) ? threadROutput.format(r) : "",
  ...
  if (isFirstCyclePoint()) { // first cycle point
    ...
    if (cycleExpanded) {
      ...
      writeBlock(getCommonCycle(x, y, z, rapto, false), step > 0 ? peckOutput.format(step) : "", lockCode);
    }
  }
}
...
function moveSubSpindle(_method, _position, _feed, _useMachineFrame, _comment, _error) {
  ...
  case TORQUE:
    ...
    writeBlock(
      ...
      gFormat.format(31),
      pOutput.format(99),
      _useMachineFrame == 1 ? gFormat.format(53) : "",
      subOutput.format(_position),
      getFeed(_feed),
      conditional(_comment, formatComment(_comment))
    );
